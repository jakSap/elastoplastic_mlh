...
/**
 * Time step control factors:
 * - COURANT_FACT: CFL condition factor (limits time step based on particle velocity and sound speed)
 *   Note: 'sml' here is defined up to the kernel's zero point, not half of it – adjust accordingly.
 * - FORCES_FACT: limits time step based on maximum particle acceleration to ensure numerical stability
**/
